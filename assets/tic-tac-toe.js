...
function runSpeechRecognition() {
	...
	recognition.onresult = function(event) {
		...
		if (transcript == "11") {
			cellClicked("cell0");
		} else if (transcript == "12") {
			cellClicked("cell1");
		} else if (transcript == "13") {
			cellClicked("cell2");
		} else if (transcript == "14") {
			cellClicked("cell3");
		} else if (transcript == "15") {
			cellClicked("cell4");
		} else if (transcript == "16") {
			cellClicked("cell5");
		} else if (transcript == "17") {
			cellClicked("cell6");
		} else if (transcript == "18") {
			cellClicked("cell7");
		} else if (transcript == "19") {
			cellClicked("cell8");
		}
